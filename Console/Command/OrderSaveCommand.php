...
namespace Sofinco\Epayment\Console\Command;
...
class OrderSaveCommand extends Command
{
    ...
    {
        $this->setName('sofinco:saveorder')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('<info>Starting Sofinco SaveOrder Test</info>');
        ...
        $output->writeln('<info>End Sofinco SaveOrder Test</info>');
    }
