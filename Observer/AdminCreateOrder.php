    ...
    public function execute(EventObserver $observer)
    {
        ...
        if (!is_null($oldOrder)) {
            ...
            if (!is_null($order)) {
                ...
                // Payment information
                $payment->setSfcoAction($oldPayment->getSfcoAction());
                $payment->setSfcoAuthorization($oldPayment->getSfcoAuthorization());
                $payment->setSfcoCapture($oldPayment->getSfcoCapture());
                $payment->setSfcoFirstPayment($oldPayment->getSfcoFirstPayment());
                $payment->setSfcoSecondPayment($oldPayment->getSfcoSecondPayment());
                $payment->setSfcoSecondThird($oldPayment->getSfcoSecondPThird());
                $payment->setSfcoDelay($oldPayment->getSfcoDelay());
                $payment->setSfcoSecondPayment($oldPayment->getSfcoSecondPayment());
