...
use Sofinco\Epayment\Model\Ui\Sfcos3xcbConfig;

/**
 * Class ConfigProvider
 */
final class Sfcos3xcbConfigProvider implements ConfigProviderInterface
{
    const CODE = 'sfco_s3xcb';
    ...
    public function getCards()
    {
        ...
        $sfcos3xcbConfig = $object_manager->get('Sofinco\Epayment\Model\Ui\Sfcos3xcbConfig');
        ...
        $cards = [];
        $types = $sfcos3xcbConfig->getCards();
        if (!is_array($types)) {
            $types = explode(',', $types);
        }
