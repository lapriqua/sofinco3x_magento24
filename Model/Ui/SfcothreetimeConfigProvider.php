...
use Sofinco\Epayment\Model\Ui\SfcothreetimeConfig;

/**
 * Class ConfigProvider
 */
final class SfcothreetimeConfigProvider implements ConfigProviderInterface
{
    ...
    public function getCards()
    {
        ...
        $sfcothreetimeConfig = $object_manager->get('Sofinco\Epayment\Model\Ui\SfcothreetimeConfig');
        ...
        $cards = [];
        $types = $sfcothreetimeConfig->getCards();
        if (!is_array($types)) {
            $types = explode(',', $types);
        }
