 ...
 */
class Sfcos3xcbsfConfig
{
    const PAYMENT_METHOD_SFCOS3XCB_CODE = 'sfco_s3xcbsf';
    const PAYMENT_METHOD_SFCOS3XCB_XML_PATH = 'payment/sfco_s3xcbsf/cctypes';
     ...
     * @var string
     */
    // protected $_formBlockType = 'Sofinco\Epayment\Block\Form\Sfcos3xcbsf';

    /**
     * @var string
     */
    // protected $_infoBlockType = 'Sofinco\Epayment\Block\Info\Sfcos3xcbsf';
