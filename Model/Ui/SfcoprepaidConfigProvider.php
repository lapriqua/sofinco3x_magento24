...
use Sofinco\Epayment\Model\Ui\SfcoprepaidConfig;

/**
 * Class ConfigProvider
 */
final class SfcoprepaidConfigProvider implements ConfigProviderInterface
{
    const CODE = 'sfco_prepaid';
    ...
    public function getCards()
    {
        ...
        $sfcoprepaidConfig = $object_manager->get('Sofinco\Epayment\Model\Ui\SfcoprepaidConfig');
        ...
        $cards = [];
        $types = $sfcoprepaidConfig->getCards();
        if (!is_array($types)) {
            $types = explode(',', $types);
        }
