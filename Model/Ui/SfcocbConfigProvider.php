...
use Sofinco\Epayment\Model\Ui\SfcocbConfig;

/**
 * Class ConfigProvider
 */
final class SfcocbConfigProvider implements ConfigProviderInterface
{
    const CODE = 'sfco_cb';
    /**
    ...
    public function getCards()
    {
        ...
        $sfcocbConfig = $object_manager->get('Sofinco\Epayment\Model\Ui\SfcocbConfig');
