...
use Sofinco\Epayment\Model\Ui\SfcofinancialConfig;

/**
 * Class ConfigProvider
 */
final class SfcofinancialConfigProvider implements ConfigProviderInterface
{
    const CODE = 'sfco_financial';
    ...
    public function getCards()
    {
        ...
        $sfcofinancialConfig = $object_manager->get('Sofinco\Epayment\Model\Ui\SfcofinancialConfig');
