...
use Sofinco\Epayment\Model\Ui\SfcopaybuttonsConfig;

/**
 * Class ConfigProvider
 */
final class SfcopaybuttonsConfigProvider implements ConfigProviderInterface
{
    const CODE = 'sfco_paybuttons';
    ...
    public function getCards()
    {
        ...
        $sfcopaybuttonsConfig = $object_manager->get('Sofinco\Epayment\Model\Ui\SfcopaybuttonsConfig');
        ...
        $cards = [];
        $types = $sfcopaybuttonsConfig->getCards();
        if (!is_array($types)) {
            $types = explode(',', $types);
        }
