...
class Failed extends \Sofinco\Epayment\Controller\Payment
{
    public function execute()
    {
        try {
            ...
            $message = sprintf('Order %d: Customer is back from Sofinco payment page. Payment refused by Sofinco (%d).', $order->getIncrementId(), $params['error']);
            $this->logDebug($message);

            $message = __('Payment refused by Sofinco.');
