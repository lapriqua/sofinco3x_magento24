...
class Cancel extends \Sofinco\Epayment\Controller\Payment
{
    public function execute()
    {
        try {
            ...
            $message = sprintf('Order %d: Payment was canceled by user on Sofinco payment page.', $order->getIncrementId());
